...
public class CharacterGenerator
{
	...
	// TODO Cambiado AssetBundleRequest por GameObject
	// static Dictionary<string, AssetBundleRequest> characterBaseRequests = new Dictionary<string, AssetBundleRequest>();
	static Dictionary<string, Object> characterBaseRequests = new Dictionary<string, Object>();
    ...
    public bool ConfigReady
    {
        get
        {
			...
			if (!characterBaseRequests.ContainsKey(currentCharacter))
				characterBaseRequests.Add(currentCharacter, CurrentCharacterBase.assetBundle.Load("characterbase", typeof(GameObject)));
    ...
    {
        GameObject root = (GameObject)Object.Instantiate(characterBaseRequests[currentCharacter]);
